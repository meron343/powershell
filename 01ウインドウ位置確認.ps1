...
Get-Process | Where-Object {$_.MainWindowTitle -ne ""} | Format-Table Name, Id -AutoSize | Out-File -FilePath R:\handre_list.txt
Get-Process | Out-File -FilePath R:\process_list.txt
